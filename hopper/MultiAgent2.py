...
if __name__ == "__main__":
    ...
    agent_thigh.load(directory='Thigh', format='numpy')
    agent_leg.load(directory='Leg', format='numpy')
    agent_foot.load(directory='Foot', format='numpy')
    ...
    agent_thigh.save(directory='Thigh2', format='numpy')
    agent_leg.save(directory='Leg2', format='numpy')
    agent_foot.save(directory='Foot2', format='numpy')
    agent_thigh.close()
    agent_leg.close()
    agent_foot.close()
    environment.close()
